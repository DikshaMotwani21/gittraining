              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-6" style="font-family: 'aaa', cursive;">
                    ...
                    <br>
                    <br>
                    <button type="submit" class="btn btn-lg" style="height:40px; width:100px">Save</button>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <button type="submit" class="btn btn-lg" style="height:40px; width:100px">Cancel</button>
                  </div>
                </div>
              </div>
            </div>
