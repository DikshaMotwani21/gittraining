      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="jumbotron" style="height:300px; width:500px">
              <h4 align="left">Enter your username:</h4>
              <input type="text" name="username" size="50">
              <br>
              <br>
              <br>
              <br>
              <a class="btn btn-block btn-large btn-primary">Send me Reset password Link!</a>
            </div>
          </div>
        </div>
      </div>
